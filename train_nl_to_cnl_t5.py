...
def train_nl_to_cnl_t5(args, log_writer):
    # model
    ...
    train_dataset = Nl_to_Cnl_with_T5_Dataset(args, tokenizer, args.train_file_path)
    ...
    for epoch in epoch_iterator:
        for batch in tqdm(train_dataloader,  desc="Step", disable=args.disable_tqdm):
            ...
            log_writer.add_scalar("train_nl_to_cnl_t5_loss", loss, global_step)
...
if __name__ == '__main__':
    ...
    train_nl_to_cnl_t5(args, log_writer)
    log_writer.close()