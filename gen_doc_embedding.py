...
def InferenceEmbeddingFromStreamDataLoader(
    ...
    tmp_n = 0
    expect_per_block_passage_num = 3844000 # ~6.9GB
    block_size = expect_per_block_passage_num // eval_batch_size
    block_id = 0
...
# python gen_doc_embeddings.py --config Config/gen_doc_embedding.toml
