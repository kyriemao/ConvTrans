...
def train(args, log_writer):
    ...
    # data prepare
    train_dataset = ConvDataset(args, query_tokenizer, passage_tokenizer, args.train_file_path)

    train_loader = DataLoader(train_dataset, 
                                batch_size = args.batch_size, 
                                shuffle=True, 
                                collate_fn=train_dataset.get_collate_fn(args, add_doc_info=True, mode="train_aol"))
...
#  python pretrain_aol.py --config Config/pretrain_aol.toml 